...
setup(
    ...
    version='v0.4.12',  # version number
    ...
    download_url='https://github.com/mortazavilab/Topyfic/archive/refs/tags/v0.4.12.tar.gz',  # link to the tar.gz file associated with this release
