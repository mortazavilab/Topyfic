...
setup(
    ...
    version='v0.3.11',  # version number
    ...
    download_url='https://github.com/mortazavilab/Topyfic/archive/refs/tags/v0.3.11.tar.gz',  # link to the tar.gz file associated with this release
